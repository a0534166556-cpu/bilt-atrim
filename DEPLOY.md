...
| `CJ_MARKUP_PERCENT` | `75` | אחוז הרווח על העלות הכוללת (מוצר + משלוח) |
...
**נוסחה (ברירת מחדל):** `(עלות מוצר $ + משלוח CJ $) × 1.75 רווח × שער` → עיגול ל-₪  
המחיר באתר הוא **כולל הכול** – הלקוח מקבל **משלוח חינם** בקופה (אין תוספת ₪).  
דוגמה: מוצר **$2** + משלוח **$3** = $5 × 1.75 × 3.75 = **₪33** סופי ללקוח, רווח 75%.
